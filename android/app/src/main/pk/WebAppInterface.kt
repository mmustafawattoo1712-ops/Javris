...
class WebAppInterface(private val mContext: Context) {
    ...
    fun sendWhatsAppMessage(name: String, message: String) {
        ...
        if (number != null) {
            // Direct Link Method (Most Reliable for "Real" functionality)
            try {
                // If number doesn't start with country code, default to Pakistan +92 (Change as needed)
                ...
                // Accessibility Service will handle the "Send" click if configured
            } catch (e: Exception) {
