...
class JarvisNotificationService : NotificationListenerService() {
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification?) {
        ...
        // Filter for WhatsApp or Messages
        if (packageName == "com.whatsapp" || packageName == "com.google.android.apps.messaging") {
            ...
            if (extras != null) {
                ...
                if (text.isNotEmpty()) {
                    ...
                    // In a real production app, you would send this to the WebView immediately
                    // using a BroadcastReceiver or direct static reference callback.
                }
            }
        }
    }
